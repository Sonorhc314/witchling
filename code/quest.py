...
class Journal:
    def __init__(self, scroll_index, current_quest):
        ...
        self.quest1 = '''Quest: Wind potion for Emily & Swan. 
        ~Dear Tiki, We've heard about your potionmaking talent, please create 1 wind potion for us.'''
        ...
        self.dialog = dialog.Dialog(self.quests[self.current_quest], f"Quest {self.current_quest}")
        self.scroll_index=scroll_index
        self.max_length= self.dialog.get_rows_in_text_box()
    def update_journal(self, new_scroll_index):
        self.dialog.set_text(self.quests[self.current_quest])
