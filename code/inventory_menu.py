...
class Inventory_menu:
    def __init__(self, inventory):
        ...
        self.rect_items = pygame.Rect(WIDTH/4,HEIGHT/4,WIDTH/4, HEIGHT/2)
        self.rect_player = pygame.Rect(WIDTH/2,HEIGHT/4,WIDTH/4, HEIGHT/2)
        self.image = pygame.image.load("graphics\player\down_idle\down_idle.png")
        self.grid_size_x = 80
        self.grid_size_y = 92
    ...
    def display(self):
        ...
        for x in range(self.rect_items.x, self.rect_items.x + WIDTH//4, 80):
            pygame.draw.line(self.display_surface, (0, 0, 0), (x, self.rect_items.y), (x, self.rect_items.y + HEIGHT/2), 3)

        for y in range(self.rect_items.y, self.rect_items.y + HEIGHT//2, self.grid_size_y):
        ...
        image = pygame.image.load("graphics\player\down_idle\down_idle.png").convert_alpha()
        ...
        for x in range(self.rect_player.x, self.rect_player.x + WIDTH//4, 80):
